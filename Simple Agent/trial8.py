    ...
    def _run(self, input: str) -> str:
        ...
        prompt = PromptTemplate(
            ...
            template=(
                ...
                "{retrieved_context}\n\n"
                "Generate 10 questions of type {question_type} and return them with their correct answers."
            )
        )
        ...
        if response:
            return f"FINAL ANSWER: Here are the generated questions:\n{response.content.strip()}"
        else:
...
prompt = PromptTemplate.from_template(
    ...
    THOUGHT: The questions have been generated. The task is complete.
    FINAL ANSWER: Here are the generated questions: <generated_questions>
